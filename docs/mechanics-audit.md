...
The source-family manifest identifies CMS ACA/Medicaid, HHS ACF LIHEAP/TANF, IRS SOI, SSA, and USDA SNAP Chronicle packages; those are the administrative fact families behind the mappings above. (`POP@8828dee:packages/populace-build/src/populace/build/us/target_parity_feed_families.json:47-85`; `POP@8828dee:packages/populace-build/src/populace/build/us/target_parity_manifest.json:440-522,634-689`)
